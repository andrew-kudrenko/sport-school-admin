...
async function requestBase<T = any>(
  headers: Headers,
  endPoint: string,
...
function createAuthRequest() {
  ...
  async function requestJSON<T = any>(
    ...
    try {
      const userData: ICachedUserData | null = JSON.parse(
...
export const {
  requestJSON: requestJSONAuth,
  requestFormData: requestFormDataAuth,
} = createAuthRequest();
